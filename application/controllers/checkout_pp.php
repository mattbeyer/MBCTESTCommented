...
class Checkout_pp extends CI_Controller {
	...
	public function index() {
		...
		$nvpreq = $nvpreq . '&RETURNURL=' . base_url(). '/index.php/ctest/pp_review&'; // this is the return URL after completion.
		$nvpreq = $nvpreq . '&CANCELURL=' . base_url(). '/paypal/cancel.php'; // this is the cancel URL if payment cancelled.

		// Send shopping cart contents and return/cancel URL's to Paypal to get a token.
		...
		// Launch paypal.com payment page containing shopping cart information already sent to paypal.com
